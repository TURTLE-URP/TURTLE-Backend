...
CREATE TABLE "Ingredientes_Plato" (
    ...
    "id_medida_insumo" INTEGER NOT NULL,
    "cantidad" DECIMAL NOT NULL,
    "id_almacen_sustraccion" INTEGER NOT NULL,
...
CREATE TABLE "Productos_Proveedor" (
    ...
    "SKU" TEXT,
    "id_insumo" INTEGER NOT NULL,
    "id_insumo_medida" INTEGER NOT NULL,
...
CREATE TABLE "Detalles_Orden_Abasto" (
    ...
    "id_orden_abasto" INTEGER NOT NULL,
...
CREATE TABLE "Detalles_Arribo_Abasto" (
    ...
    "cantidad" SMALLINT NOT NULL,
    "id_producto_proveedor" INTEGER NOT NULL,
    "id_arribo_abasto" INTEGER NOT NULL,
...
CREATE TABLE "Distribucion_Abasto" (
    "id" SERIAL NOT NULL,
    "codigo" TEXT NOT NULL,
    "fecha_hora_distribucion" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "id_arribo_abasto" INTEGER NOT NULL,
...
CREATE TABLE "Detalles_Distribucion_Abasto" (
    ...
    "id_distribucion_abasto" INTEGER NOT NULL,
